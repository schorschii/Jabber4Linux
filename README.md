...
apt install python3-requests python3-dnspython python3-pyqt5 portaudio19-dev python3-watchdog python3-cryptography python3-filelock python3-pip python3-venv python3-setuptools libopus0
